...
namespace Tasks.Persistence.Data.Queries
{
	public class ProjectMemberQueryService : IProjectMemberQueryService
	{
		...
		public ProjectMemberQueryService(ILogger<ProjectMemberQueryService> logger, ProjectTasksDbContext context, IUserReadRepository userReadRepository)
		{
			_logger = logger;
			_context = context;
