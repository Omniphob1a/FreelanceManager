...
{
	public record TaskUnassignedDomainEvent(Guid TaskId, Guid AssigneeId) : DomainEvent(TaskId, nameof(ProjectTask))
	{
		public override string EventType => "tasks.unassigned";
