...
{
	public record TaskAssignedDomainEvent(Guid TaskId, Guid AssigneeId) : DomainEvent(TaskId, nameof(ProjectTask))
	{
		public override string EventType => "tasks.assigned";
