...
{
	public class RescheduleSingleMilestoneCommandHandler : IRequestHandler<RescheduleSingleMilestoneCommand, Result>
	{
		private readonly IProjectRepository _repository;
		private readonly IProjectQueryService _queryService;
		private readonly IUnitOfWork _unitOfWork;
		private readonly ILogger<RescheduleSingleMilestoneCommandHandler> _logger;
		private readonly IMapper _mapper;

		public RescheduleSingleMilestoneCommandHandler(IProjectRepository repository,
			IProjectQueryService queryService,
			IUnitOfWork unitOfWork,
			ILogger<RescheduleSingleMilestoneCommandHandler> logger,
			IMapper mapper)
		{
		...
		public async Task<Result> Handle(RescheduleSingleMilestoneCommand request, CancellationToken ct)
		{
